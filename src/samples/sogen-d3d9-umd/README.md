...
x86_64-w64-mingw32-g++ -O2 -std=c++20 d3d9_lock_pitch_test.cpp \
    -static -static-libgcc -static-libstdc++ -o d3d9-lock-pitch-test-x64.exe -ld3d9
...
x86_64-w64-mingw32-g++ -O2 -std=c++20 d3d9_lock_readback_test.cpp \
    -static -static-libgcc -static-libstdc++ -o d3d9-lock-readback-test-x64.exe -ld3d9 -ld3dcompiler_43

i686-w64-mingw32-g++ -O2 -std=c++20 d3d9_lock_readback_test.cpp \
    -static -static-libgcc -static-libstdc++ -o d3d9-lock-readback-test-x86.exe -ld3d9 -ld3dcompiler_43

x86_64-w64-mingw32-g++ -O2 -std=c++20 d3d9_viewport_scissor_cache_test.cpp \
    -static -static-libgcc -static-libstdc++ -o d3d9-viewport-scissor-cache-test-x64.exe -ld3d9 -ld3dcompiler_43

i686-w64-mingw32-g++ -O2 -std=c++20 d3d9_viewport_scissor_cache_test.cpp \
    -static -static-libgcc -static-libstdc++ -o d3d9-viewport-scissor-cache-test-x86.exe -ld3d9 -ld3dcompiler_43
