...
namespace sogen
{
    ...
    std::vector<std::string> parse_window_classes(std::string_view manifest_text);
    std::optional<assembly_identity> parse_self_identity(std::string_view manifest_text);
