...
namespace sogen
{
                                                               ...
                                                               const std::vector<resolved_assembly>& assemblies)
    {
        ...
        constexpr std::uint32_t toc_entry_count = 2;
        constexpr std::uint32_t toc_size = toc_header_size + toc_entry_count * sizeof(activation_context_data_toc_entry);
        ...
        const std::uint32_t total_size = dll_redirection_section_start + static_cast<std::uint32_t>(dll_redirection_section.bytes.size());
