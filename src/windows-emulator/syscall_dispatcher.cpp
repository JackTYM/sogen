...
namespace sogen
{
    ...
    namespace
    {
        ...
        //
        // Both offsets are resolved against 32-bit ntdll.dll 10.0.20348.51391 and are not guaranteed to
        // hold for other builds; the writable-section and not-yet-zero/not-yet-initialized checks below
        // guard against patching an unrelated field on a build where they don't.
        ...
        void ensure_nls_lead_byte_info_table(windows_emulator& win_emu)
        {
            ...
            const auto* ntdll_mod = win_emu.mod_manager.wow64_modules_.ntdll32;
