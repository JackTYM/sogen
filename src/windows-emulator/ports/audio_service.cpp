        ...
        struct audio_service_port : rpc_port
        {
          ...
          private:
                                          ...
                                          std::vector<alpc_reply_handle>& reply_handles)
            {
                ...
                // +0x16C, +0x170) and the buffer duration (+0x14C) are patched below to match this stream.
                //
                ...
                //   - ring geometry requires [+0x168] < [+0x16C] <= [+0x170] (v11[90]>=v11[91] || v11[91]>v11[92]
                //     fails @ 0x10038A08-0x10038A1A) - the capture had +0x168 and +0x16C set to the same value,
                ...
                std::array<uint8_t, 0x1c4> render_control_header = {
                    ...
                    0x00, 0x00, 0x00, 0x00, 0x00,                                                                   // 0x0B4: size selector
                    ...
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x96, 0x98, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                               // 0x14C: period 0x989680
                    0xff, 0xff, 0xff, 0xff, 0x80, 0x01, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, // 0x164: render-data offset
                    0x00, 0x00, 0x00, 0x00,                                                 // 0x168: ring lower bound (0)
                    0x20, 0x66, 0x05, 0x00,                                                 // 0x16C: ring requested extent
                    0x00, 0x00, 0x00, 0x00,                                                 // 0x170: ring upper bound
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                         // 0x178: reserved
                    0xfe, 0xff, 0x02, 0x00, 0x44, 0xac, 0x00, 0x00, 0x20, 0x62, 0x05, 0x00, 0x08, 0x00, 0x20, 0x00, // 0x17C:
                    0x16, 0x00, 0x20, 0x00, 0x03, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00,
                    0xaa, 0x00, 0x38, 0x9b, 0x71, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                ...
                std::memcpy(&render_control_header[0x14C], &duration_hns, sizeof(duration_hns));
