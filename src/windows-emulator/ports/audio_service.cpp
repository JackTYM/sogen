        ...
        struct audio_service_port : rpc_port
        {
          ...
          private:
                                          ...
                                          std::vector<alpc_reply_handle>& reply_handles)
            {
                ...
                // +0x168, +0x16C) and the buffer duration (+0x14C) are patched below to match this stream.
                //
                // CCrossProcessBaseClientEndpoint::Initialize's FIRST content check is the "DCPE" magic at +0x0C0
                // (a mismatch aborts with 0x887C0045 and the client tears the stream down immediately after
                // CreateRemoteStream, without ever calling StartStream) - see commit 6ef62298 for the original,
                // disassembly-derived RE of this layout (size selector at +0x0B4, magic at +0x0C0, format-block
                // size at +0x0C4). The capture this array was replayed from had the magic 8 bytes later than that
                // (+0x0C8), silently regressing the same bug the 2026-08-05 fix already closed once.
                std::array<uint8_t, 0x1c0> render_control_header = {
                    ...
                    0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                   // 0x0B4: size selector
                    0x44, 0x43, 0x50, 0x45, 0xde, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x0C0: "DCPE", 0x0C4: format-block size (222)
                    , // 0x14C:
                                                                                                                                // period
                                                                                                                                // 0x989680
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x80, 0x01, 0x00,
                    0x00, 0x00, 0x04, 0x00, 0x00, 0x20, 0x66, 0x05, 0x00, 0x20, 0x66, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, 0x00, 0xfe, 0xff, 0x02, 0x00, 0x44, 0xac, 0x00, 0x00, 0x20, 0x62, 0x05, 0x00, 0x08, 0x00, 0x20, 0x00, 0x16,
                    0x00, 0x20, 0x00, // WAVEFORMATEXTENSIBLE
                    0x03, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b,
