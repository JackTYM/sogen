...
namespace sogen
{
    ...
    namespace syscalls
    {
        ...
        BOOL handle_NtUserEnableNonClientDpiScaling(const syscall_context& c, hwnd window);
        BOOL handle_NtUserGetWindowDisplayAffinity(const syscall_context& c, hwnd window, emulator_object<uint32_t> affinity);
        ...
        BOOL handle_NtUserRegisterPointerDeviceNotifications(const syscall_context& c, hwnd hWnd, BOOL notify_range);
...
#define add_handler(syscall)                                                            \
    ...
    {                                                                                   \
        ...
        add_handler(NtUserRegisterPointerDeviceNotifications);
