...
// Header-only WoW64 gate-crossing state marshaling for the FEX backend.
namespace sogen::fex
{
    ...
    // corrupting both engines' independent state the next time either runs - do NOT reach for
