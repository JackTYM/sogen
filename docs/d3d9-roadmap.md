...
- [x] **WoW64/x86 shader path** — done, see the WoW64 row in the milestone table above. Typed
  ...
  Lock support is now fixed on x86 too (2026-07-06, see "Known bugs & limitations" above). **Still
  open:** 5 low-confidence DDI slot arities (`pfnCheckCounter`, `pfnSetMarker`,
