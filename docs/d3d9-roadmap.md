...
instancing, cube/volume textures, more formats, SM3.0 caps) can proceed in roughly the order listed
above. `D3DPOOL_MANAGED`'s confirmed-permanent limitation should be treated as a standing
